...
public class Bird_Category extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bird_category);
...
//        ------------------------------------------------------------------------------------------------
        ...
        uploadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (mImageUri == null){
                    Toast.makeText(Bird_Category. this, "Please Upload Image", Toast.LENGTH_SHORT).show();
                }else {
        ...
        if(name.isEmpty()){
            ...
            fileRef.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            pd.dismiss();
                            Toast.makeText(Bird_Category.this, "Uploaded Successfully", Toast.LENGTH_SHORT).show();
                            Clearall();
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    Toast.makeText(Bird_Category.this, "Uploading Failed !!", Toast.LENGTH_SHORT).show();
                }
            });
