...
public class NewPost28 extends AppCompatActivity {
...
@SuppressLint("MissingInflatedId")
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_post28);
...
//        ------------------------------------------------------------------------------------------------
               ...
               root = FirebaseDatabase.getInstance().getReference(ID).child("User Posts");
                ...
                uploadImage.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if (mImageUri == null){
                            Toast.makeText(NewPost28. this, "Please Upload Image", Toast.LENGTH_SHORT).show();
                        }else {
    ...
    if(name.isEmpty()){
        ...
        fileRef.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        pd.dismiss();
                        Toast.makeText(NewPost28.this, "Uploaded Successfully", Toast.LENGTH_SHORT).show();
                        Clearall();
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(NewPost28.this, "Uploading Failed !!", Toast.LENGTH_SHORT).show();
            }
        });
